...
def experiment(variant, seed=None):
    ...
    context_score_encoder = SelfAttnEncoder(
        input_dim=context_encoder_output_dim + context_encoder_output_dim,
        num_output_mlp=0,
    )
...
@click.option("--wandb_project_name", default='Ours')
@click.option("--wandb_run_name", default='Ours')
@click.option("--csv_name", default='Ours')
