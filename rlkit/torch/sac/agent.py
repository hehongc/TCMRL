...
class PEARLAgent(nn.Module):
    ...
    def infer_posterior(self, context, task_indices=None):
        ...
        # self.context_encoder is a MLP module or a LSTM module.
        ...
        if self.use_ib:
            ...
            params, self.z_means, self.scores, self.scores_sigmoid,  _, self.reverse_z_means = self.context_score_encoder(params, z_means)
