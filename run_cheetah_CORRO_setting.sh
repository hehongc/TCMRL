#!/bin/bash
 ...
 declare -a wandb_project_names=( "IDAQ_HC" )
 declare -a wandb_run_names=( "Random_negative" )
 declare -a csv_names=( "Random_negative" )
 n=0
 # 52 54 21
 # 52 54 21 dense
 gpunum=5
 ...
 /home/hehongcai/code/New_IDAQ/IDAQ_Public-MUJOCO/data/cheetah-vel \
 --gpu=${n} \
