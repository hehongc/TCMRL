#!/bin/bash
 ...
 declare -a wandb_project_names=( "IDAQ" )
 declare -a wandb_run_names=( "point-robot_IDAQ_org_cpearl" )
 n=2
 # 52 54 21
 # 52 54 21 dense
 gpunum=4
 ...
 >& out_logs/${Foldername}/IDAQ_org_${task}_${algo}_${datadir}_${is_sparse}_${use_brac}_${use_information_bottleneck}_${is_zloss}_${is_onlineadapt_thres}_${is_onlineadapt_max}_${num_exp_traj_eval}_${allow_backward_z}_${is_true_sparse}_${r_thres}_${seed}_${n}.txt &
