#!/bin/bash
 ...
 declare -a wandb_project_names=( "IDAQ_PR_new" )
 declare -a wandb_run_names=( "rew_loss_10" )
 declare -a csv_names=( "rew_loss_10" )
 n=3
 # 52 54 21
 # 52 54 21 dense
 gpunum=4
 ...
 /home/hehongcai/code/New_IDAQ/IDAQ_Public-MUJOCO/data/sparse-point-robot \
 --gpu=${n} \
